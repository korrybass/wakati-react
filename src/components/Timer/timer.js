...
class Timer extends Component {
    ...
    countDown (time) {
        ...
        var updateLoop = setInterval(function () {
            ...
            else{ self.updateElement(updatedTime) };
        }, 1000 );
    };
      ...
      <div className="timer-container">
        <div id="wakati">
            ...
            <div className="wakati-buttons">
                <button className="action-btn" disabled={this.state.inProgress} id="wakati-start" onClick={this.startTimer.bind(this)} type="button">Start</button>
            </div>
